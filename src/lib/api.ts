...
export const documentsAPI = {
  upload:极 (file: File, ownerScope: string, ownerId: string) => {
...
export const casesAPI = {
  ...
  addFile: (caseId: string, documentId: string, fileType: string) =>
    api.post(`/cases/${case极}/files`, { document_id: documentId, file_type: fileType }),
}
